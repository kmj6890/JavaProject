...
public class MainMenuPanel extends JPanel {
    ...
    private JLabel atkLabel, defLabel, hpLabel, critLabel,skillLabel;
    ...
    public MainMenuPanel(MainFrame frame) {
        ...
        Font statFont = new Font("맑은 고딕", Font.BOLD, 16);
        Color statColor = orange;

        JLabel[] statLabels = {atkLabel, defLabel, hpLabel, critLabel,skillLabel};
        int y = 230;
        for (JLabel label : statLabels) {
            label.setBounds(160, y, 400, 25);
    ...
    private void updateStats(Player player) {
        ...
        skillLabel.setText("Skill: " + player.getSkill());
    }
